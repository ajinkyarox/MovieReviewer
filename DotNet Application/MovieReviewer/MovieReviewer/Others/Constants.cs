...
namespace MovieReviewer.Others
{
    ...
    {
        public static string[] nWords = { "disappointing","disappointed","disappoint","bad","worse","worst","worsens","could have been better","fail","failed","failure"
        ,"bomb","bombed"
        };
        ...
        public static string[] positiveNeutral = {"doesn't disappoint","is not that disappointing","doesn't feel disappointed","lived upto the","lives upto the","not that bad","wasn't that bad","wasn't that worse","doesn't fail","is not a failure"};
